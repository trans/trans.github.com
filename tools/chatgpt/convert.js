...
.note { background:#111; border:1px solid #333; border-left:3px solid orange; padding:10px 14px; font-size:12px; color:#aaa; margin:0 0 28px; }
...
.msg .who { font-size:11px; letter-spacing:1px; text-transform:uppercase; color:orange; margin:0 0 8px; }
